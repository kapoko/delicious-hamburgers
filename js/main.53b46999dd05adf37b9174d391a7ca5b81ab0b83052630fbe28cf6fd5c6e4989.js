(() => {
  // ns-hugo:/home/runner/work/delicious-hamburgers/delicious-hamburgers/site/assets/js/helpers/domReady.js
  ...
  var begin = function begin2(name2) {
    p.mark("".concat(preamble, " ").concat(name2, " begins"));
    return function() {
      return end(name2);
    };
  };
  var end = function end2(name2) {
    p.mark("".concat(preamble, " ").concat(name2, " ends"));
    p.measure("".concat(preamble, " ").concat(name2), "".concat(preamble, " ").concat(name2, " begins"), "".concat(preamble, " ").concat(name2, " ends"));
  };
  var perf = {
    begin,
    end
  ...
  var createElement2 = createElementInDocument(document2);
  ...
  var parse2 = function(str, sep, eq, decodeURIComponent) {
    if (sep == null) {
      sep = "&";
    }
    if (eq == null) {
  ...
  var getColorScheme = function(declarations) {
    ...
    var colorSchemes = parse2(declarations, ";", ":", function(str) {
      return str.replace(/^[ \t\n\f\r]+|[ \t\n\f\r]+$/g, "");
    });
  ...
  var octicon = function(icon3, height) {
    icon3 = toLowerCase(icon3).replace(/^octicon-/, "");
    if (!hasOwnProperty(data, icon3)) {
      icon3 = "mark-github";
    }
    var defaultHeight = height >= 24 && /* istanbul ignore next */
    24 in data[icon3].heights ? (
      /* istanbul ignore next */
      24
    ) : 16;
    var svg = data[icon3].heights[defaultHeight];
    return '<svg viewBox="0 0 ' + svg.width + " " + defaultHeight + '" width="' + height * svg.width / defaultHeight + '" height="' + height + '" class="octicon octicon-' + icon3 + '" aria-hidden="true">' + svg.path + "</svg>";
  };
  var queues = {};
  ...
  var render$1 = function(root, options, func) {
    var createElement3 = createElementInDocument(root.ownerDocument);
    var style = root.appendChild(createElement3("style", {
      type: "text/css"
    }));
    ...
    var btn = createElement3("a", {
      ...
      createElement3("span", {}, [options["data-text"] || ""])
    ]);
    var widget = root.appendChild(createElement3("div", {
    ...
    var api2 = path[2] ? "/repos/" + path[1] + "/" + path[2] : "/users/" + path[1];
    fetch.call(this, apiBaseURL + api2, function(error, json) {
      if (!error) {
        var data2 = json[property];
        widget.appendChild(createElement3("a", {
  ...
  var set2 = function(el, size) {
    el.style.width = size[0] + "px";
    el.style.height = size[1] + "px";
  };
  var render3 = function(options, func) {
    ...
    if (useShadowDOM) {
      var host = createElement2("span");
      render$1(host.attachShadow({ mode: "closed" }), options, function() {
        func(host);
      });
    } else {
      var iframe = createElement2("iframe", {
        src: "javascript:0",
        title: options.title || void 0,
  ...
  var variationPlacements = /* @__PURE__ */ basePlacements.reduce(function(acc, placement) {
    return acc.concat([placement + "-" + start, placement + "-" + end3]);
  }, []);
  var placements = /* @__PURE__ */ [].concat(basePlacements, [auto]).reduce(function(acc, placement) {
    return acc.concat([placement, placement + "-" + start, placement + "-" + end3]);
  }, []);
  ...
  function updateTransitionEndListener(box, action, listener3) {
    var method = action + "EventListener";
    ["transitionend", "webkitTransitionEnd"].forEach(function(event) {
      box[method](event, listener3);
    });
  }
  ...
  function createTippy(reference2, passedProps) {
    ...
    function onTransitionEnd(duration, callback) {
      ...
      function listener3(event) {
        if (event.target === box) {
          updateTransitionEndListener(box, "remove", listener3);
          callback();
        }
      }
      if (duration === 0) {
      ...
      updateTransitionEndListener(box, "add", listener3);
  ...
  // <stdin>
  library$1.add(faDownload, faGithub, faCode, faEllipsisH, faAngleLeft, faAngleRight, faInfo, faCircle);
  dom$1.watch();
  domReady(() => {
    ...
    let auto2 = document.getElementById("auto-activate");
    if (auto2) {
      let hamburgers2 = auto2.querySelectorAll(".hamburger");
      hamburgers2.forEach((hamburger, i) => {
        setTimeout(function() {
